      ...
      <div class="services" id="nosotros">
          <div class="container flex flex-wrap mt-10">
              <div class="w-full md:w-2/5">
                  ...
                  <p class=" text-base sm:text-xl text-black" data-aos="fade-up" data-aos-delay="500">En departamentos amplios, funcionales y perfectamente distribuidos que se adaptan a tu estilo de vida.</p>
                  <ul class="services-list list-none mt-8" data-aos="fade-up" data-aos-delay="600"> 
                    <li><p>Iluminación y ventilación natural.</p></li>
                    <li><p>Sala lounge de uso común.</p></li>
          ...
          <div class="container mt-8 xs:mt-10"> 
              <div class="gallery slider w-full  flex flex-no-wrap justify-center"  id="gallery">
                <div class="w-full  md:w-1/3"  data-aos="fade-up" data-aos-delay="100">
     ...
     <div class="w-full espacios mt-16 " id="departamentos">
            ...
            <div class="live-info">
              ...
              <!-- plano fila start 1 -->
               <div class="live-info__squard w-full flex flex-nowrap ">
                ...
                <div class="w-2/6 md:w-1/6 py-2 text-center flex border-r border-white justify-center items-center bg-gray-200">
                    <div>
                      <p class="text-black font-semibold" >
                        Techada 79.83 m2 <br>
                        Terraza 19.50 m2 <br>
      ...
      <div class="container">
        <div class="live-description text-dark mt-6">
          <h1 class="font-bold py-3 px-3 md:px-6 text-sm sm:text-xl tracking-widest text-center">Estacionamiento Simple $11,200.00 / S/36,960.00 Depósitos desde $840.00 / S/2,772.00
        
          </h1>
          <p class=" text-sm sm:text-base mt-5 text-black">Precio referencial incluye IGV. Disponible hasta agotar los departamentos, estacionamientos o depósitos y es sujeto a cambios.
            Tipo de cambio referencial de S/0.00, la venta se realizará en dólares al tipo de cambio vigente del día.</p>
        </div>
      </div>
          ...
          <div class="container">
              <div class="flex flex-wrap">
                  ...
                  <div class="w-full md:w-1/2 mt-8 md:mt-0">
                    <iframe class="w-full h-256 sm:h-600 md:h-full" class="mapaGoogle w_100 w_55_desktop" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3901.30438944382!2d-77.062392228287!3d-12.091302045529366!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9105c9a94286d6b1%3A0x3de1973a14debc82!2sRodolfo+Rutte+642%2C+Lima+15076!5e0!3m2!1ses-419!2spe!4v1553845830198!5m2!1ses-419!2spe"
             ...
             <div id="orm-message" class="form-message hidden">
                <div class="flex mt-8 rounded overflow-hidden ">
                  ...
                  <div class=" bg-white py-2 px-6 text-green-500 ">
                    <p class="block text-xs md:text-base">¡Gracias por contactarnos! Estaremos en contacto con usted en breve.</p>
                  </div>
                </div>
             </div>
             <?php 
